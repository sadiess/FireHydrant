...
DATA_PATH = "/uscms/home/sadie/nobackup/ffAna-master/mvatrain/data/signal_190813.awkd"
OUTPUT_DIR = "/uscms/home/sadie/nobackup/ffAna-master/mvatrain/outputs/earl_grey_strong_redux"
REPORT_DIR = "/uscms/home/sadie/nobackup/CleanFork/FireHydrant/debugging/reports/190815"
...
def main():
    ...
    #for easy comparison, we print out the predictions into a text file. since the predictions are separated into the
    #train_test_split subsets, we just print one after the other and include the text file with the res of our reports.
    fpath = join(REPORT_DIR, "performance_report_predictions.txt")
    f = open(fpath, "w+")
    f.write("train:\n")
    for x in train_preds_optimized.flatten():
        f.write(str(x)+"\n")
    f.write("test:\n")
    for x in test_preds_optimized.flatten():
        f.write(str(x)+"\n")
    f.close()
